...
export default function FinalCTA() {
  return (
    <section className="min-h-screen flex items-center justify-center py-24 bg-white overflow-hidden relative">
      ...
      <div className="max-w-5xl mx-auto px-6 relative z-10">
        <motion.div
          className="bg-gradient-to-r from-[#1E40AF] to-[#3B82F6] rounded-3xl p-14 md:p-25 text-center shadow-2xl relative overflow-hidden"
        ...
        >
          ...
          <div className="relative z-10 text-center max-w-3xl mx-auto">
            ...
            <motion.h2
              className="text-2xl md:text-3xl lg:text-5xl text-white mb-8 tracking-wide leading-snug"
              style={{ fontFamily: 'Inter, -apple-system, sans-serif' }}
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            <motion.p
              className="text-base md:text-lg text-white/90 mb-14 leading-relaxed"
              style={{ fontFamily: 'Inter, -apple-system, sans-serif' }}
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            <motion.div
              className="flex flex-col sm:flex-row gap-6 justify-center mt-6 mb-12"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
